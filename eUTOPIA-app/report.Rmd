...
```{r}
params$input$experiment_description
```


# Data
```{r}
print(paste("Selected array type: ",params$input$arrType,sep = ""))
print(paste("Number of samples: ",nrow(params$gVars$phTable),sep = ""))

```

# Filtering
```{r}
print(paste("Quantile Based Cutoff: ",params$input$filtDist,sep = ""))
print(paste("Percentage of Samples: ",params$input$perSamples,sep = ""))

if(params$input$arrType=="il_methyl"){
  print(paste("P.value detection threshold: ",params$input$detectPV,sep = ""))
}

print("Description of parameter selection:")
print(params$input$filtering_description)
```
...
if(params$input$arrType =="af_exp"){
  print("No normalization for affymetrix data")
}else{
  if(params$input$arrType=="il_methyl"){
  print(paste("Normalization Method: ",params$input$normMethod,sep = ""))
}else{
  print(paste("Normalization Type: ",params$input$normMethod,sep = ""))
  print(paste("Normalization Method: ",params$input$normMethod2,sep = ""))
}
}

print("Description of parameter selection:")
print(params$input$normalization_description)

```

# Annotation
```{r}
  print(paste("Annotation type: ",params$input$annType,sep = ""))
  print(paste("Annotation to: ", params$input$ID,sep = ""))
  
  print("Description of parameter selection:")
  print(params$input$annotation_description)
```
...
if(params$input$corrType=="sc") {
  print("SVA+ComBat correction")

  print(paste("SVA variables of interests: ", params$input$varISva))
  print("SVA covariates: ")
  print(paste(params$input$coVarSva, collapse = ";"))
  print("SVA batches: ")
  print(paste(params$input$batchSva, collapse = ";"))
  
  print(paste("Combat variables of interests: ", params$input$varICombat))
  print("Combat covariates: ")
  print(paste(params$input$coVarCombat, collapse = ";"))
  print("Combat batches: ")
  print(paste(params$input$batchCombat, collapse = ";"))
  
}

if(params$input$corrType=="c"){
  print("ComBat correction")
  print(paste("variables of interests: ", params$input$varICombat))
  print("covariates: ")
  print(paste(params$input$coVarCombat, collapse = ";"))
  print("batches: ")
  print(paste(params$input$batchCombat, collapse = ";"))
...
if(params$input$corrType=="s"){
  print("SVA correction")
  print(paste("variables of interests: ", params$input$varISva))
  print("covariates: ")
  print(paste(params$input$coVarSva, collapse = ";"))
  print("batches: ")
  print(paste(params$input$batchSva, collapse = ";"))
...
if(params$input$corrType=="n") print("No correction")
print("Description of parameter selection:")
print(params$input$batch_description)
```

# Differential analysis
```{r}
print("Limma:")
print(paste("variable of interests: ",params$input$varILimma, sep = ""))
print("covariates: ")
print(paste(params$input$coVarLimma, collapse  = ";"))
print("Contrasts: ")
print(paste(params$input$comps, collapse = ";"))
print(paste("P.adj method: ",params$input$pvAdjMethod, sep = ""))


if(!is.null(params$gVars$filteredDeTable)){
  print("Differential gene selection criteria:")
  print(paste("Log-fold-change threshold: ", params$gVars$lfcFilt, sep = ""))
  print(paste("Pvlue threshold: ",as.numeric(params$input$pvThr), sep = ""))
  print(paste("Selection based on pvalue: ",params$gVars$pvType, sep = ""))
}

print("Description of parameter selection:")
print(params$input$DEG_description)
```
