...
if(isNorm){
        if(!is.null(params$input$mdsLabel) && !is.null(params$input$mdsColor)){
                ...
                limma:::plotMDS(norm.data, top=topNum, labels=as.character(phFactor[,params$input$mdsLabel]), col=colVec, gene.selection="common", main="Before removing any batch", cex=0.5)
        }else{
...
if(isCorr){
        if(!is.null(params$input$mdsLabel) && !is.null(params$input$mdsColor)){
                ...
                limma:::plotMDS(comb.data, top=topNum, labels=as.character(phFactor[,params$input$mdsLabel]), col=colVec, gene.selection="common", main="After removing batches", cex=0.5)
        }else{
                print("Missing label and color information...")
        }
}else{
...
if(isAgg){
        if(!is.null(params$input$mdsLabel) && !is.null(params$input$mdsColor)){
                if(grepl("ag_exp.*", params$input$arrType)){
                        ...
                        limma:::plotMDS(agg.data, top=topNum, labels=as.character(phFactor[,params$input$mdsLabel]), col=colVec, gene.selection="common", main="After aggregation", cex=0.5)
                }else{
