...
if(isDeg){
        ...
        degSel <- deg[deg$y>=params$input$adjPvThr & abs(deg$x)>=params$input$lfcThr,]
...
<!-- ```{r intersection_plot, echo=F, fig.height=9, fig.width=9, eval=isDeg} -->
```{r intersection_plot, echo=F, fig.height=9, fig.width=9}
if(isDeg){
